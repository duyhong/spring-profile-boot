   ...
   <script type="text/javascript">
   		...
   		//This will give you select file into base64 encoding
   			...
   			function deleteRow(cid){
   				...
   				$.get("${pageContext.request.contextPath}/jdeleteCustomer?cid="+cid,function(result){
   			...
   			function showEditModal(cid,email,name){
    ...
    <tbody>
      ...
      <c:forEach items="${customers}" var="customer">
       ...
       <td tdname="city">${customer.city}</td>
            <td>
            <img tdname="rowphoto" id="${customer.cid}_imageicon" src="${customer.photo}" style="height: 100px;"/>
             <a href="javascript:deleteRow('${customer.cid}');">
             <img  src="${pageContext.request.contextPath}/images/delete.png"></a>
             /
             <a href="javascript:showEditModal(${customer.cid},'${customer.email}','${customer.name}');">
