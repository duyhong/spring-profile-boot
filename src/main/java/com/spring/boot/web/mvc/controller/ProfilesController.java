...
public class ProfilesController {
	...
	@ResponseBody
	public ApplicationResponse jdeleteCustomer(@RequestParam("cid") int cid,Model model){
		//String email=request.getParameter("email");
		String status=customerService.deleteCustomerByCid(cid);
	...
	@ResponseBody public ApplicationResponse editProfile(@ModelAttribute Customer customer){
		System.out.println("____updating wwwwwwwwwwwwwwwwwwwwwwwwwwwcustomer data");
